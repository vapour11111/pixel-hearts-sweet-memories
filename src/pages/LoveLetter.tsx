...
const LoveLetter: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pastel-lavender to-pastel-pink star-bg pt-20 pb-10 px-4">
      <FloatingHearts />
      
      <div className="container mx-auto max-w-3xl">
        <h1 className="text-3xl md:text-4xl font-pixel text-dark-pink mb-8 text-center pt-8">My Love Letter to You</h1>
        
        <div className="bg-white/90 backdrop-blur-sm rounded-lg retro-shadow pixel-border p-8 mb-10 relative">
          {!isOpen ? (
            <div className="text-center">
              <div className="mb-8">
                <Heart className="h-16 w-16 mx-auto text-accent-pink animate-pulse-soft" />
              </div>
              ...
              <PixelButton onClick={() => setIsOpen(true)} variant="candy">
                Open Letter ♥
              </PixelButton>
            </div>
          ) : (
            <div className="letter-content">
              <div className="text-right mb-4">
                <p className="font-cute text-accent-pink">May 3rd, 2025</p>
              </div>
              ...
              <div className="text-right">
                <p className="font-handwritten text-xl text-accent-pink">With all my heart,</p>
                <p className="font-handwritten text-xl text-accent-pink">Your Name</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="mt-8 flex justify-center">
          <Link to="/favorites">
            <PixelButton>Our Favorites</PixelButton>
          </Link>
        </div>
      </div>
    </div>
